      ...
      <div className="about-content">
        ...
        <div className="about-text">
          <p className="animate-on-scroll">
            <span className="highlight animate-on-scroll">DOBs</span> is a{" "}
            <span className="highlight animate-on-scroll">legendary</span>{" "}
            character within the Digital world of Solana, known as the{" "}
            <span className="highlight animate-on-scroll">
              Guardian of Trust
            </span>
            . He embodies{" "}
            <span className="highlight animate-on-scroll">integrity</span>,{" "}
            <span className="highlight animate-on-scroll">transparency</span>,
            and{" "}
            <span className="highlight animate-on-scroll">
          ...
          <p className="animate-on-scroll">
            DOBs' unwavering{" "}
            <span className="highlight animate-on-scroll">dedication</span>{" "}
            thrives and conflicts are{" "}
            <span className="highlight animate-on-scroll">
              peacefully resolved
            </span>
            , making him a referred figure in Solana's history.
          </p>
        </div>
      </div>
    </section>
